...
namespace MyGame
{
	public class Position
	{
		...
		public const int RANGER_CELL_X = 158;
		public const int TOWN_IMAGE_X = 38;
		public const int MAGE_IMAGE_X = 103;
		public const int RANGER_IMAGE_X = 163;
		public const int HEALER_IMAGE_X = 223;
		public const int NINJA_IMAGE_X = 283;
		public const int TOWN_LABEL_X = 38;
		public const int MAGE_LABEL_X = 98;
		public const int RANGER_LABEL_X = 158;
